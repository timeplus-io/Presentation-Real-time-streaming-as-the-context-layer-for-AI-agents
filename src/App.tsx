...
import { Clock, Zap, Timer, GitMerge, Database, Bell, AlertTriangle, TrendingDown, TrendingUp, BarChart3, Quote, Shield, Activity, Settings, Users, Truck, Lightbulb } from 'lucide-react';
...
export default function App() {
  ...
  return (
    <Deck>
      ...
      {/* Slide 12: Use Cases - Security & DevOps */}
      <div className="flex flex-col px-6 md:px-20 pt-6 md:pt-10 max-w-7xl mx-auto h-full">
        <motion.div
          initial={{ x: 50, opacity: 0 }}
          animate={{ x: 0, opacity: 1 }}
      ...
      {/* Slide 13: Use Cases - Finance & IoT */}
      <div className="flex flex-col px-6 md:px-20 pt-6 md:pt-10 max-w-7xl mx-auto h-full">
        <motion.div
          initial={{ x: 50, opacity: 0 }}
          animate={{ x: 0, opacity: 1 }}
      ...
      {/* Slide 14: Use Cases - CX & Supply Chain */}
      <div className="flex flex-col px-6 md:px-20 pt-6 md:pt-10 max-w-7xl mx-auto h-full">
        <motion.div
          initial={{ x: 50, opacity: 0 }}
          animate={{ x: 0, opacity: 1 }}
